...
public final class DBHandler {
    ...
    private static String DB_URL = "jdbc:mysql://localhost/retail";
    private static String DB_USER = "root";
    private static String DB_PASSWORD = "Franjescal 1997";
    private static String defaultUsername = "jotech";
    ...
    private static void readPropertiesFile() {
        ...
        try (FileReader reader = new FileReader("dao.properties")) {
    ...
    private static void setupUserTable() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (!(count > 0)) {
                    if(statement.executeUpdate(query3)>0){
                        connection.commit();
                    }else {
                        connection.rollback();
                    }
